...
const {
  ...
  const i = { delta: 0, timestamp: 0, isProcessing: !1 },
    ...
    { read: l, resolveKeyframes: u, update: c, preRender: h, render: d, postRender: p } = a,
    f = () => {
...
const d = {
  now: () => (void 0 === c && d.set(l.isProcessing || s ? l.timestamp : performance.now()), c),
  set: (t) => {
...
class y {
  ...
  attachTimeline(t, e) {
    const n = this.animations.map((n) => (g() && n.attachTimeline ? n.attachTimeline(t) : e(n)));
    return () => {
      n.forEach((t, e) => {
...
const S = (t, e, n) => (n > e ? e : n < t ? t : n),
  V = 0.001;
function A({ duration: t = 800, bounce: e = 0.25, velocity: n = 0, mass: s = 1 }) {
  let i,
    r,
    o = 1 - e;
  ((o = S(0.05, 1, o)),
      ...
      ? ((i = (e) => {
        ...
        (r = (e) => {
          const s = e * o * t,
            ...
            l = Math.exp(-s),
            u = P(Math.pow(e, 2), o);
          return ((-i(e) + V > 0 ? -1 : 1) * ((r - a) * l)) / u;
        }))
      : ((i = (e) => Math.exp(-e * t) * ((e - n) * t + 1) - 0.001),
        (r = (e) => Math.exp(-e * t) * (t * t * (n - e)))));
  const a = (function (t, e, n) {
    let s = n;
    for (let n = 1; n < M; n++) s -= t(s) / e(s);
    return s;
  })(i, r, 5 / t);
  if (((t = v(t)), isNaN(a))) return { stiffness: 100, damping: 10, duration: t };
  {
...
function E({ keyframes: t, restDelta: e, restSpeed: n, ...s }) {
  const i = t[0],
    r = t[t.length - 1],
    o = { done: !1, value: i },
    {
  ...
  if ((n || (n = y ? 0.01 : 2), e || (e = y ? 0.005 : 0.5), f < 1)) {
    ...
    T = (e) => {
      ...
      return r - n * (((p + f * g * m) / t) * Math.sin(t * e) + m * Math.cos(t * e));
    };
  } else if (1 === f) T = (t) => r - Math.exp(-g * t) * (m + (p + g * m) * t);
  else {
    const t = g * Math.sqrt(f * f - 1);
    T = (e) => {
      const n = Math.exp(-f * g * e),
        s = Math.min(t * e, 300);
      return r - (n * ((p + f * g * m) * Math.sinh(s) + t * m * Math.cosh(s))) / t;
    };
  }
  return {
...
function R(t) {
  let e = 0;
  let n = t.next(e);
  for (; !n.done && e < O;) ((e += 50), (n = t.next(e)));
  return e >= O ? 1 / 0 : e;
}
function B(t, e = 100, n) {
  const s = n({ ...t, keyframes: [0, e] }),
    i = Math.min(R(s), O);
  return { type: "keyframes", ease: (t) => s.next(i * t).value / e, duration: w(i) };
}
...
function K(t, e, n) {
  ...
  if ("string" == typeof t) {
    let i = document;
    (e && (x(Boolean(e.current)), (i = e.current)),
      n
        ? ((null !== (s = n[t]) && void 0 !== s) || (n[t] = i.querySelectorAll(t)), (t = n[t]))
...
function q(t, e) {
  return Y(t) ? t[U(0, t.length, e)] : t;
}
function X(e, n, s, i, r, o) {
  !(function (e, n, s) {
  ...
  for (let t = 0; t < n.length; t++) e.push({ value: n[t], at: I(r, o, i[t]), easing: q(s, t) });
}
function G(t, e) {
...
const tt = (t) => "number" == typeof t,
  ...
  it = new Set(st),
  rt = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
  ot = { type: "keyframes", duration: 0.8 },
  at = { type: "keyframes", ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
  lt = (t, { keyframes: e }) =>
    e.length > 2
      ? ot
      : it.has(t)
...
const ct = (t) => null !== t;
function ht(t, { repeat: e, repeatType: n = "loop" }, s) {
  const i = t.filter(ct),
    r = e && "loop" !== n && e % 2 == 1 ? 0 : i.length - 1;
  return r && void 0 !== s ? s : i[r];
}
const dt = (t, e, n) => (((1 - 3 * n + 3 * e) * t + (3 * n - 6 * e)) * t + 3 * e) * t;
function pt(t, e, n, s) {
  if (t === e && n === s) return i;
  const r = (e) =>
    (function (t, e, n, s, i) {
      let r,
        ...
        a = 0;
      do {
        ((o = e + (n - e) / 2), (r = dt(o, s, i) - t), r > 0 ? (n = o) : (e = o));
      } while (Math.abs(r) > 1e-7 && ++a < 12);
      return o;
    })(e, 0, 1, t, n);
  return (t) => (0 === t || 1 === t ? t : dt(r(t), e, s));
}
const ft = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
  mt = (t) => (e) => 1 - t(1 - e),
  gt = pt(0.33, 1.53, 0.69, 0.99),
  yt = mt(gt),
  vt = ft(yt),
  wt = (t) => ((t *= 2) < 1 ? 0.5 * yt(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1)))),
  bt = (t) => 1 - Math.sin(Math.acos(t)),
  Tt = mt(bt),
  xt = ft(bt),
  St = (t) => /^0[^.\s]+$/u.test(t);
const Vt = (t) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(t),
  At = (t) => (e) => "string" == typeof e && e.startsWith(t),
  Mt = At("--"),
  Pt = At("var(--"),
  kt = (t) => !!Pt(t) && Ft.test(t.split("/*")[0].trim()),
  Ft = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu,
...
function Et(t, e, n = 1) {
  ...
  if (r) {
    const t = r.trim();
    return Vt(t) ? parseFloat(t) : t;
  }
  return kt(i) ? Et(i, e, n + 1) : i;
}
const Ot = { test: (t) => "number" == typeof t, parse: parseFloat, transform: (t) => t },
  Rt = { ...Ot, transform: (t) => S(0, 1, t) },
  Bt = { ...Ot, default: 1 },
  It = (t) => ({
  ...
  Nt = It("vh"),
  Kt = It("vw"),
  $t = { ...Wt, parse: (t) => Wt.parse(t) / 100, transform: (t) => Wt.transform(100 * t) },
  jt = new Set([
    "width",
    "height",
    "top",
  ...
  zt = (t) => t === Ot || t === Dt,
  Ht = (t, e) => parseFloat(t.split(", ")[e]),
  Ut =
    (t, e) =>
    (n, { transform: s }) => {
      if ("none" === s || !s) return 0;
      const i = s.match(/^matrix3d\((.+)\)$/u);
      if (i) return Ht(i[1], e);
      {
...
const Gt = (t) => (e) => e.test(t),
  Zt = [Ot, Dt, Wt, Lt, Kt, Nt, { test: (t) => "auto" === t, parse: (t) => t }],
  _t = (t) => Zt.find(Gt(t)),
  Jt = new Set();
let Qt = !1,
  te = !1;
function ee() {
  if (te) {
    const t = Array.from(Jt).filter((t) => t.needsMeasurement),
  ...
  ((te = !1), (Qt = !1), Jt.forEach((t) => t.complete()), Jt.clear());
}
function ne() {
  Jt.forEach((t) => {
...
class se {
  ...
  scheduleResolve() {
    ((this.isScheduled = !0),
      this.isAsync
        ? (Jt.add(this), Qt || ((Qt = !0), o.read(ne), o.resolveKeyframes(ee)))
...
const ie = (t) => Math.round(1e5 * t) / 1e5,
  re = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu;
const oe =
    /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu,
  ae = (t, e) => (n) =>
    Boolean(
      ("string" == typeof n && oe.test(n) && n.startsWith(t)) ||
      (e &&
        !(function (t) {
          return null == t;
        })(n) &&
  ...
  ue = { ...Ot, transform: (t) => Math.round(((t) => S(0, 255, t))(t)) },
  ce = {
    test: ae("rgb", "red"),
...
const he = {
  ...
  pe = {
    test: (t) => ce.test(t) || he.test(t) || de.test(t),
    parse: (t) => (ce.test(t) ? ce.parse(t) : de.test(t) ? de.parse(t) : he.parse(t)),
    transform: (t) =>
      "string" == typeof t ? t : t.hasOwnProperty("red") ? ce.transform(t) : de.transform(t)
  },
  fe =
...
function ve(t) {
  ...
  const o = e
    .replace(
      ...
      (t) => (
        pe.test(t)
          ? (s.color.push(r), i.push(ge), n.push(pe.parse(t)))
          : t.startsWith("var(")
            ? (s.var.push(r), i.push("var"), n.push(t))
            : (s.number.push(r), i.push(me), n.push(parseFloat(t))),
        ++r,
        "${}"
      )
    )
...
function be(t) {
  ...
  return (t) => {
    ...
    for (let r = 0; r < s; r++)
      if (((i += e[r]), void 0 !== t[r])) {
        const e = n[r];
        i += e === me ? ie(t[r]) : e === ge ? pe.transform(t[r]) : t[r];
      }
    return i;
  };
}
const Te = (t) => ("number" == typeof t ? 0 : t);
const xe = {
    test: function (t) {
      var e, n;
      return (
        isNaN(t) &&
        "string" == typeof t &&
        ((null === (e = t.match(re)) || void 0 === e ? void 0 : e.length) || 0) +
          ((null === (n = t.match(fe)) || void 0 === n ? void 0 : n.length) || 0) >
          0
      );
    },
    parse: we,
    createTransformer: be,
    getAnimatableNone: function (t) {
      const e = we(t);
      return be(t)(e.map(Te));
    }
  },
  Se = new Set(["brightness", "contrast", "saturate", "opacity"]);
function Ve(t) {
...
const Ae = /\b([a-z-]*)\(.*?\)/gu,
  ...
  Fe = { ...Ot, transform: Math.round },
  Ce = { ...Pe, ...ke, zIndex: Fe, size: Dt, fillOpacity: Rt, strokeOpacity: Rt, numOctaves: Fe },
  Ee = {
    ...Ce,
    color: pe,
    backgroundColor: pe,
...
function Re(t, e) {
  let n = Oe(t);
  return (n !== Me && (n = xe), n.getAnimatableNone ? n.getAnimatableNone(e) : void 0);
}
const Be = new Set(["auto", "none", "0"]);
class Ie extends se {
  ...
  readKeyframes() {
    ...
    for (let n = 0; n < t.length; n++) {
      ...
      if ("string" == typeof s && ((s = s.trim()), kt(s))) {
        const i = Et(s, e.current);
        (void 0 !== i && (t[n] = i), n === t.length - 1 && (this.finalKeyframe = s));
      }
    }
    if ((this.resolveNoneKeyframes(), !jt.has(n) || 2 !== t.length)) return;
    const [s, i] = t,
      r = _t(s),
      o = _t(i);
    if (r !== o)
  ...
  resolveNoneKeyframes() {
    ...
    for (let e = 0; e < t.length; e++)
      ("number" == typeof (s = t[e])
        ? 0 === s
        : null === s || "none" === s || "0" === s || St(s)) && n.push(e);
    var s;
    n.length &&
      (function (t, e, n) {
        let s,
        ...
        for (; i < t.length && !s;) {
          const e = t[i];
          ("string" == typeof e && !Be.has(e) && ve(e).values.length && (s = t[i]), i++);
        }
        if (s && n) for (const i of e) t[i] = Re(n, s);
      })(t, n, e);
  }
  measureInitialState() {
    ...
    ("height" === n && (this.suspendedScrollY = window.pageYOffset),
      (this.measuredOrigin = Xt[n](t.measureViewportBox(), window.getComputedStyle(t.current))),
  ...
  measureEndState() {
    ...
    const r = s.length - 1,
      o = s[r];
    ((s[r] = Xt[n](e.measureViewportBox(), window.getComputedStyle(e.current))),
...
const Le = (t, e) =>
  ...
  (!("number" != typeof t && !Array.isArray(t)) ||
    !("string" != typeof t || (!xe.test(t) && "0" !== t) || t.startsWith("url(")));
function We(t, e, n, s) {
  const i = t[0];
  if (null === i) return !1;
...
class De {
  ...
  get resolved() {
    return (this._resolved || this.hasAttemptedResolve || (ne(), ee()), this._resolved);
  }
  ...
  return (
    S(0),
    {
      ...
      next: (t) => {
        let e = !1;
        return (
          x || void 0 !== T || ((e = !0), w(t), S(t)),
          void 0 !== T && t >= T ? x.next(t - T) : (!e && w(t), d)
        );
      }
    }
  );
}
const Ke = pt(0.42, 0, 1, 1),
  $e = pt(0, 0, 0.58, 1),
  je = pt(0.42, 0, 0.58, 1),
  ze = (t) => Array.isArray(t) && "number" == typeof t[0],
  He = {
    linear: i,
    easeIn: Ke,
    easeInOut: je,
...
const Ze = (t, e, n) => {
  ...
  _e = [he, ce, de];
function Je(t) {
  const e = ((n = t), _e.find((t) => t.test(n)));
  var n;
      ...
      (s = (function ({ hue: t, saturation: e, lightness: n, alpha: s }) {
        ...
        if ((e /= 100)) {
          const s = n < 0.5 ? n * (1 + e) : n + e - n * e,
            a = 2 * n - s;
          ((i = Xe(a, s, t + 1 / 3)), (r = Xe(a, s, t)), (o = Xe(a, s, t - 1 / 3)));
        } else i = r = o = n;
        return {
...
const Qe = (t, e) => {
    const n = Je(t),
      s = Je(e);
    if (!n || !s) return Ge(t, e);
    const i = { ...n };
    return (t) => (
      (i.red = Ze(n.red, s.red, t)),
      (i.green = Ze(n.green, s.green, t)),
      (i.blue = Ze(n.blue, s.blue, t)),
      (i.alpha = I(n.alpha, s.alpha, t)),
      ce.transform(i)
    );
  },
...
function rn(t, e) {
  const n = { ...t, ...e },
    s = {};
  for (const i in n) void 0 !== t[i] && void 0 !== e[i] && (s[i] = nn(t[i])(t[i], e[i]));
  return (t) => {
...
const on = (t, e) => {
  const n = xe.createTransformer(e),
    s = ve(t),
    i = ve(e);
  return s.indexes.var.length === i.indexes.var.length &&
    ...
    ? (tn.has(t) && !i.values.length) || (tn.has(e) && !s.values.length)
      ? (function (t, e) {
...
function an(t, e, n) {
  if ("number" == typeof t && "number" == typeof e && "number" == typeof n) return I(t, e, n);
  return nn(t)(t, e);
}
function ln(t, e, { clamp: n = !0, ease: s, mixer: r } = {}) {
  const o = t.length;
  if ((x(o === e.length), 1 === o)) return () => e[0];
  ...
  const a = (function (t, e, n) {
    ...
    u = (e) => {
      ...
      const s = L(t[n], t[n + 1], e);
      return a[n](s);
    };
  return n ? (e) => u(S(t[0], t[o - 1], e)) : u;
}
function un({ duration: t = 300, keyframes: e, times: n, ease: s = "easeInOut" }) {
  const i = Y(s) ? s.map(Ue) : Ue(s),
    r = { done: !1, value: e[0] },
    o = (function (t, e) {
      return t.map((t) => t * e);
    })(n && n.length === e.length ? n : D(e), t),
    a = ln(o, e, {
      ease: Array.isArray(i) ? i : ((l = e), (u = i), l.map(() => u || je).splice(0, l.length - 1))
    });
  var l, u;
...
const cn = (t) => {
  ...
  hn = { decay: Ne, inertia: Ne, tween: un, keyframes: un, spring: E },
  dn = (t) => t / 100;
class pn extends De {
  constructor(t) {
    (super(t),
    ...
    const { name: e, motionValue: n, element: s, keyframes: i } = this.options,
      r = (null == s ? void 0 : s.KeyframeResolver) || se;
    ((this.resolver = new r(i, (t, e) => this.onKeyframesResolved(t, e), e, n, s)),
  ...
  initPlayback(t) {
    const {
      ...
      o = z(e) ? e : hn[e] || un;
    let a, l;
    o !== un && "number" != typeof t[0] && ((a = qe(dn, an(t[0], t[1]))), (t = [0, 100]));
    const u = o({ ...this.options, keyframes: t });
    ("mirror" === i && (l = o({ ...this.options, keyframes: [...t].reverse(), velocity: -r })),
      null === u.calculatedDuration && (u.calculatedDuration = R(u)));
  ...
  tick(t, e = !1) {
    ...
    const { delay: h, repeat: d, repeatType: p, repeatDelay: f, onUpdate: m } = this.options;
    (this.speed > 0
    ...
    if (d) {
      ...
      (Boolean(e % 2) &&
        ("reverse" === p ? ((n = 1 - n), f && (n -= f / c)) : "mirror" === p && (w = r)),
        (v = S(0, 1, n) * c));
    }
    ...
    return (
      x && void 0 !== s && (b.value = ht(a, this.options, s)),
      m && m(b.value),
      x && this.finish(),
      b
    );
  ...
  play() {
    ...
    const { driver: t = cn, onPlay: e, startTime: n } = this.options;
...
const fn = new Set(["opacity", "clipPath", "filter", "transform"]),
  mn = { linearEasing: void 0 };
function gn(t, e) {
  const n = m(t);
  return () => {
    var t;
    return null !== (t = mn[e]) && void 0 !== t ? t : n();
  };
}
const yn = gn(() => {
  try {
...
function vn(t) {
  return Boolean(
    ("function" == typeof t && yn()) ||
    !t ||
    ("string" == typeof t && (t in bn || yn())) ||
    ze(t) ||
    (Array.isArray(t) && t.every(vn))
  );
}
const wn = ([t, e, n, s]) => `cubic-bezier(${t}, ${e}, ${n}, ${s})`,
  bn = {
    linear: "linear",
    ease: "ease",
    easeIn: "ease-in",
    ...
    circIn: wn([0, 0.65, 0.55, 1]),
    circOut: wn([0.55, 0, 1, 0.45]),
    backIn: wn([0.31, 0.01, 0.66, -0.59]),
    backOut: wn([0.33, 1.53, 0.69, 0.99])
  };
function Tn(t, e) {
  return t
    ? "function" == typeof t && yn()
      ? ((t, e) => {
          ...
          for (let e = 0; e < s; e++) n += t(L(0, s - 1, e)) + ", ";
          return `linear(${n.substring(0, n.length - 2)})`;
        })(t, e)
      : ze(t)
        ? wn(t)
        : Array.isArray(t)
          ? t.map((t) => Tn(t, e) || bn.easeOut)
          : bn[t]
    : void 0;
}
function xn(
...
const Vn = m(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
const An = { anticipate: wt, backInOut: vt, circInOut: xt };
class Mn extends De {
  constructor(t) {
    super(t);
    const { name: e, motionValue: n, element: s, keyframes: i } = this.options;
    ((this.resolver = new Ie(i, (t, e) => this.onKeyframesResolved(t, e), e, n, s)),
      this.resolver.scheduleResolve());
  }
  initPlayback(t, e) {
    var n;
    ...
    var c;
    if (
      ("string" == typeof r && yn() && r in An && (r = An[r]),
      z((c = this.options).type) || "spring" === c.type || !vn(c.ease))
    ) {
      const { onComplete: e, onUpdate: n, motionValue: a, element: l, ...u } = this.options,
        c = (function (t, e) {
          const n = new pn({ ...e, keyframes: t, repeat: 0, delay: 0, isGenerator: !0 });
          let s = { done: !1, value: t[0] };
          const i = [];
          let r = 0;
          for (; !s.done && r < 2e4;) ((s = n.sample(r)), i.push(s.value), (r += 10));
          return { times: void 0, keyframes: i, duration: r - 10, ease: "linear" };
        })(t, u);
    ...
    const h = xn(a.owner.current, l, t, { ...this.options, duration: s, times: i, ease: r });
    return (
      (h.startTime = null != u ? u : this.calcStartTime()),
      this.pendingTimeline
        ? (Sn(h, this.pendingTimeline), (this.pendingTimeline = void 0))
        : (h.onfinish = () => {
            const { onComplete: n } = this.options;
            (a.set(ht(t, this.options, e)), n && n(), this.cancel(), this.resolveFinishedPromise());
          }),
  ...
  stop() {
    ...
    const { resolved: t } = this;
    if (!t) return;
    const { animation: e, keyframes: n, duration: s, type: i, ease: r, times: o } = t;
...
const Pn =
    ...
    (a) => {
      ...
      return !r && Mn.supports(h) ? new Mn(h) : new pn(h);
    },
...
function On(t, e) {
  const n = (function (t, e, n) {
    const s = t.getProps();
    return Cn(s, e, void 0 !== n ? n : s.custom, t);
  })(t, e);
...
const Rn = (t) => t.replace(/([a-z])([A-Z])/gu, "$1-$2").toLowerCase(),
  Bn = "data-" + Rn("framerAppearId");
function In(t) {
  return t.props[Bn];
}
function Ln(t, e) {
  const n = t.getValue("willChange");
  if (((s = n), Boolean(N(s) && s.add))) return n.add(e);
  var s;
}
...
function Dn(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
  ...
  for (const e in u) {
    const s = t.getValue(e, null !== (r = t.latestValues[e]) && void 0 !== r ? r : null),
      i = u[e];
    if (void 0 === i || (h && Wn(h, e))) continue;
    const l = { delay: n, ...ut(a || {}, e) };
    let d = !1;
    ...
    (Ln(t, e), s.start(Pn(e, s, i, t.shouldReduceMotion && it.has(e) ? { type: !1 } : l, t, d)));
    const p = s.animation;
    p && c.push(p);
  }
  return (
...
const Nn = {};
function Kn(t, { layout: e, layoutId: n }) {
  return (
    it.has(t) || t.startsWith("origin") || ((e || void 0 !== n) && (!!Nn[t] || "opacity" === t))
  );
}
function $n(t, e, n) {
  var s;
...
const jn = "undefined" != typeof window,
  zn = { current: null },
  Hn = { current: !1 };
const Un = [
  "initial",
...
function Yn(t) {
  return (
    (null !== (e = t.animate) && "object" == typeof e && "function" == typeof e.start) ||
    Un.some((e) =>
      (function (t) {
...
const qn = {
  ...
  Xn = {};
for (const t in qn) Xn[t] = { isEnabled: (e) => qn[t].some((t) => !!e[t]) };
const Gn = [...Zt, pe, xe],
  Zn = () => ({ x: { min: 0, max: 0 }, y: { min: 0, max: 0 } }),
  _n = [
    "AnimationStart",
    "AnimationComplete",
    "Update",
...
class Jn {
  ...
  constructor(
    ...
    ((this.current = null),
      ...
      (this.scheduleRender = () => {
        const t = d.now();
        this.renderScheduledAt < t && ((this.renderScheduledAt = t), o.render(this.render, !1, !0));
      }));
    ...
    ((this.latestValues = l),
      ...
      (this.isControllingVariants = Yn(e)),
      (this.isVariantNode = (function (t) {
        return Boolean(Yn(t) || t.variants);
      })(e)),
          ...
          if (((Hn.current = !0), jn))
            if (window.matchMedia) {
              const t = window.matchMedia("(prefers-reduced-motion)"),
                e = () => (zn.current = t.matches);
              (t.addListener(e), e());
            } else zn.current = !1;
        })(),
      (this.shouldReduceMotion =
        "never" !== this.reducedMotionConfig &&
        ("always" === this.reducedMotionConfig || zn.current)),
      this.parent && this.parent.children.add(this),
      this.update(this.props, this.presenceContext));
  }
  unmount() {
    (nt.delete(this.current),
  ...
  updateFeatures() {
    ...
    for (t in Xn) {
      ...
      if (
        (!this.features[t] && s && n(this.props) && (this.features[t] = new s(this)),
        this.features[t])
      ) {
        const e = this.features[t];
  ...
  update(t, e) {
    ...
    ((this.prevMotionValues = (function (t, e, n) {
      for (const s in e) {
        ...
        else if (N(r)) t.addValue(s, f(i, { owner: t }));
        else if (r !== i)
          if (t.hasValue(s)) {
  ...
  getValue(t, e) {
    ...
    return (
      void 0 === n &&
        void 0 !== e &&
        ((n = f(null === e ? void 0 : e, { owner: this })), this.addValue(t, n)),
      n
    );
  }
  readValue(t, e) {
    ...
    let s =
      void 0 === this.latestValues[t] && this.current
        ? null !== (n = this.getBaseTargetFromProps(this.props, t)) && void 0 !== n
          ? n
    ...
    return (
      null != s &&
        ("string" == typeof s && (Vt(s) || St(s))
          ? (s = parseFloat(s))
          : ((i = s), !Gn.find(Gt(i)) && xe.test(e) && (s = Re(t, e))),
        this.setBaseTarget(t, N(s) ? s.get() : s)),
      N(s) ? s.get() : s
    );
  }
  setBaseTarget(t, e) {
...
class Qn extends Jn {
  constructor() {
    (super(...arguments), (this.KeyframeResolver = Ie));
  }
...
const ts = (t, e) => (e && "number" == typeof t ? e.transform(t) : t),
  es = { x: "translateX", y: "translateY", z: "translateZ", transformPerspective: "perspective" },
  ns = st.length;
function ss(t, e, n) {
...
function as(
  ...
  if ((ss(t, u, h), c)) return void (t.style.viewBox && (t.attrs.viewBox = t.style.viewBox));
  ...
  (d.transform && (f && (p.transform = d.transform), delete d.transform),
    f &&
      ...
      (p.transformOrigin = (function (t, e, n) {
        return `${is(e, t.x, t.width)} ${is(n, t.y, t.height)}`;
    ...
    void 0 !== o &&
      (function (t, e, n = 1, s = 0, i = !0) {
        t.pathLength = 1;
        const r = i ? rs : os;
        t[r.offset] = Dt.transform(-s);
        const o = Dt.transform(e),
          a = Dt.transform(n);
        t[r.array] = `${o} ${a}`;
      })(d, o, a, l, !1));
}
...
class cs extends Qn {
  constructor() {
    (super(...arguments),
      (this.type = "svg"),
      (this.isSVGTag = !1),
      (this.measureInstanceViewportBox = Zn));
  }
  getBaseTargetFromProps(t, e) {
    return t[e];
  }
  readValueFromInstance(t, e) {
    ...
    return ((e = ls.has(e) ? e : Rn(e)), t.getAttribute(e));
  }
  scrapeMotionValuesFromProps(t, e, n) {
    return (function (t, e, n) {
      ...
      for (const n in t)
        (N(t[n]) || N(e[n])) &&
          (s[-1 !== st.indexOf(n) ? "attr" + n.charAt(0).toUpperCase() + n.substring(1) : n] =
            t[n]);
      return s;
    })(t, e, n);
  }
  build(t, e, n) {
    as(t, e, this.isSVGTag, n.transformTemplate);
  }
  renderInstance(t, e, n, s) {
    !(function (t, e, n, s) {
      us(t, e, void 0, s);
      for (const n in e.attrs) t.setAttribute(ls.has(n) ? n : Rn(n), e.attrs[n]);
    })(t, e, 0, s);
  }
  mount(t) {
    var e;
    ((this.isSVGTag = "string" == typeof (e = t.tagName) && "svg" === e.toLowerCase()),
      super.mount(t));
  }
}
class hs extends Qn {
  ...
  readValueFromInstance(t, e) {
    ...
    }
    {
      const s = ((n = t), window.getComputedStyle(n)),
        i = (Mt(e) ? s.getPropertyValue(e) : s[e]) || 0;
...
function fs(t) {
  ...
  (e.mount(t), nt.set(t, e));
}
function ms(t, e, n, s) {
  const i = [];
  if (
    (function (t, e) {
      return N(t) || "number" == typeof t || ("string" == typeof t && !$(e));
    })(t, e)
  )
    i.push(
      (function (t, e, n) {
    ...
    for (let t = 0; t < o; t++) {
      const s = r[t],
        a = s instanceof Element ? ps : fs;
      nt.has(s) || a(s);
      const l = nt.get(s),
        u = { ...n };
      ("delay" in u && "function" == typeof u.delay && (u.delay = u.delay(t, o)),
        i.push(...Dn(l, { ...e, transition: u }, {})));
    }
  }
  return i;
}
  ...
  const s = [],
    i = (function (t, { defaultTransition: e = {}, ...n } = {}, s, i) {
      ...
      for (let n = 0; n < t.length; n++) {
        ...
        if (!Array.isArray(o)) {
          u.set(o.name, H(h, o.at, c, u));
          continue;
        }
        let [p, f, m = {}] = o;
        void 0 !== m.at && (h = H(h, m.at, c, u));
        let g = 0;
        const y = (t, n, s, o = 0, a = 0) => {
          const l = J(t),
            { delay: u = 0, times: c = D(l), type: p = "keyframes", ...f } = n;
          let { ease: m = e.ease || "easeOut", duration: y } = n;
          const w = "function" == typeof u ? u(o, a) : u,
            b = l.length,
            T = z(p) ? p : null == i ? void 0 : i[p];
          if (b <= 2 && T) {
            let t = 100;
            if (2 === b && et(l)) {
              const e = l[1] - l[0];
        ...
        if (N(p)) y(f, m, _("default", Z(p, a)));
        else {
          const t = j(p, f, s, l),
            e = t.length;
          for (let n = 0; n < e; n++) {
            const s = Z(t[n], a);
            for (const t in f) y(f[t], Q(m, t), _(t, s), n, e);
          }
        }
        ((c = h), (h += g));
      }
        ...
        a.forEach((t, s) => {
          for (const i in t) {
            ...
            for (let t = 0; t < r.length; t++) {
              ...
              (a.push(n), l.push(L(0, d, e)), u.push(s || "easeOut"));
            }
            (0 !== l[0] && (l.unshift(0), a.unshift(a[0]), u.unshift("easeInOut")),
              1 !== l[l.length - 1] && (l.push(1), a.push(null)),
              o.has(s) || o.set(s, { keyframes: {}, transition: {} }));
            const c = o.get(s);
            ((c.keyframes[i] = a),
              (c.transition[i] = { ...e, duration: d, ease: u, times: l, ...n }));
          }
        }),
        o
      );
...
function ys(t) {
  return function (e, n, s) {
    let i = [];
    var r;
    ((r = e), (i = Array.isArray(r) && Array.isArray(r[0]) ? gs(e, n, t) : ms(e, n, s, t)));
    const o = new y(i);
...
const Ss = "easeOut";
function Vs(t) {
  const e = xs.get(t) || new Map();
  return (xs.set(t, e), xs.get(t));
}
class As {
  constructor(t, e, n, s) {
    const i = e.startsWith("--");
    ((this.setValue = i ? ws : bs),
      (this.options = s),
      this.updateFinishedPromise(),
      x("string" != typeof s.type));
    const r = Vs(t).get(e);
    r && r.stop();
    if (
      (Array.isArray(n) || (n = [n]),
      (function (t, e, n) {
        for (let s = 0; s < e.length; s++)
          (null === e[s] && (e[s] = 0 === s ? n() : e[s - 1]),
            "number" == typeof e[s] && Pe[t] && (e[s] = Pe[t].transform(e[s])));
        !Ts() && e.length < 2 && e.unshift(n());
      })(e, n, () =>
        e.startsWith("--") ? t.style.getPropertyValue(e) : window.getComputedStyle(t)[e]
      ),
      z(s.type))
    ) {
      const t = B(s, 100, s.type);
      ((s.ease = yn() ? t.ease : Ss), (s.duration = v(t.duration)), (s.type = "keyframes"));
    } else s.ease = s.ease || Ss;
    this.removeAnimation = () => {
      var n;
      return null === (n = xs.get(t)) || void 0 === n ? void 0 : n.delete(e);
    };
    const o = () => {
      (this.setValue(t, e, ht(n, this.options)), this.cancel(), this.resolveFinishedPromise());
    };
    Vn()
      ? ((this.animation = xn(t, e, n, s)),
        !1 === s.autoplay && this.animation.pause(),
        (this.animation.onfinish = o),
        this.pendingTimeline && Sn(this.animation, this.pendingTimeline),
        Vs(t).set(e, this))
      : o();
  }
  get duration() {
  ...
  get time() {
    var t;
    return this.animation
      ? w((null === (t = this.animation) || void 0 === t ? void 0 : t.currentTime) || 0)
      : 0;
  }
  set time(t) {
  ...
  stop() {
    this.animation &&
      "idle" !== this.state &&
      "finished" !== this.state &&
      (this.animation.commitStyles && this.animation.commitStyles(), this.cancel());
  }
  complete() {
  ...
  attachTimeline(t) {
    return (this.animation ? Sn(this.animation, t) : (this.pendingTimeline = t), i);
  }
}
const Ms = (t) =>
    function (e, n, s) {
        ...
        (function (t, e, n, s) {
          ...
          for (let t = 0; t < r; t++) {
            ...
            for (const t in e) {
              const n = e[t],
                i = { ...ut(a, t) };
              ((i.duration = i.duration ? v(i.duration) : i.duration),
                (i.delay = v(i.delay || 0)),
                o.push(new As(s, t, n, i)));
            }
          }
          return o;
        })(e, n, s, t)
  ...
  ks = new WeakMap();
let Fs;
function Cs({ target: t, contentRect: e, borderBoxSize: n }) {
  var s;
  null === (s = ks.get(t)) ||
    void 0 === s ||
    s.forEach((s) => {
...
function Os(t, e) {
  Fs || ("undefined" != typeof ResizeObserver && (Fs = new ResizeObserver(Es)));
  const n = K(t);
  return (
    n.forEach((t) => {
      let n = ks.get(t);
      (n || ((n = new Set()), ks.set(t, n)), n.add(e), null == Fs || Fs.observe(t));
    }),
    () => {
      n.forEach((t) => {
        const n = ks.get(t);
        (null == n || n.delete(e), (null == n ? void 0 : n.size) || null == Fs || Fs.unobserve(t));
      });
    }
  );
}
...
function Is(t) {
  return (
    ...
    () => {
      (Rs.delete(t), !Rs.size && Bs && (Bs = void 0));
    }
  );
}
const Ls = { x: { length: "Width", position: "Left" }, y: { length: "Height", position: "Top" } };
function Ws(t, e, s, i) {
  const r = s[e],
    { length: o, position: a } = Ls[e],
    l = r.current,
    u = s.time;
  ((r.current = t[`scroll${a}`]),
    ...
    (r.progress = L(0, r.scrollLength, r.current)));
  const c = i - u;
  r.velocity = c > 50 ? 0 : n(r.current - l, c);
}
const Ds = {
    Enter: [
      [0, 1],
  ...
  Ns = { start: 0, center: 0.5, end: 1 };
function Ks(t, e, n = 0) {
  let s = 0;
  if ((t in Ns && (t = Ns[t]), "string" == typeof t)) {
...
function js(t, e, n, s) {
  ...
  return (
    "number" == typeof t
      ? (i = [t, t])
      : "string" == typeof t &&
        (i = (t = t.trim()).includes(" ") ? t.split(" ") : [t, Ns[t] ? t : "0"]),
    (r = Ks(i[0], n, s)),
    (o = Ks(i[1], e)),
    r - o
  );
...
function Hs(t, e, n) {
  ...
  const h = s.length;
  for (let t = 0; t < h; t++) {
    const n = js(s[t], u[o], l[o], a[r]);
    (c || n === e[r].interpolatorOffsets[t] || (c = !0), (e[r].offset[t] = n));
  }
  (c && ((e[r].interpolate = ln(e[r].offset, D(s))), (e[r].interpolatorOffsets = [...e[r].offset])),
...
const Ys = new WeakMap(),
  qs = new WeakMap(),
  Xs = new WeakMap(),
  Gs = (t) => (t === document.documentElement ? window : t);
function Zs(t, { container: e = document.documentElement, ...n } = {}) {
  let s = Xs.get(e);
  s || ((s = new Set()), Xs.set(e, s));
  const i = Us(
    e,
    t,
    {
  ...
  if ((s.add(i), !Ys.has(e))) {
    ...
    (window.addEventListener("resize", a, { passive: !0 }),
      e !== document.documentElement &&
        qs.set(e, ((u = a), "function" == typeof (r = e) ? Is(r) : Os(r, u))),
  ...
  return (
    ...
    () => {
      ...
      (Ys.delete(e),
        s &&
          (Gs(e).removeEventListener("scroll", s),
          null === (t = qs.get(e)) || void 0 === t || t(),
...
const Js = new Map();
function Qs({ source: t, container: e = document.documentElement, axis: n = "y" } = {}) {
  (t && (e = t), Js.has(e) || Js.set(e, {}));
  const s = Js.get(e);
  return (
    s[n] ||
      (s[n] = g()
...
const ni = { some: 0, all: 1 };
function si(t, e, { root: n, margin: s, amount: i = "some" } = {}) {
  const r = K(t),
    o = new WeakMap(),
    a = new IntersectionObserver(
      ...
      { root: n, rootMargin: s, threshold: "number" == typeof i ? i : ni[i] }
    );
...
function ri(t = 0.1, { startDelay: e = 0, from: n = 0, ease: s } = {}) {
  return (i, r) => {
    const o =
        "number" == typeof n
          ? n
...
function oi(...t) {
  const e = !Array.isArray(t[0]),
    ...
    o = t[3 + n],
    a = ln(i, r, {
      mixer: ((l = r[0]), ((t) => t && "object" == typeof t && t.mix)(l) ? l.mix : void 0),
      ...o
    });
  var l;
  return e ? a(s) : a;
...
export default null;
//# sourceMappingURL=/sm/d5d4bfa5a3f292edc74ce2b856e25f03ebbfa4c4c22aa37e3f75ca1dabe374b0.map
